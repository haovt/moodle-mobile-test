...
var AddonBlogEntriesPage = /** @class */ (function () {
    ...
    AddonBlogEntriesPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-addon-blog-entries',template:/*ion-inline-start:"D:\src\gupolenseignement\src\addon\blog\pages\entries\entries.html"*/'<ion-header>\n    <ion-navbar core-back-button>\n        <ion-title>{{ title | translate }}</ion-title>\n        <ion-buttons end></ion-buttons>\n    </ion-navbar>\n</ion-header>\n<addon-blog-entries class="core-avoid-header" [courseId]="courseId" [userId]="userId" [cmId]="cmId" [entryId]="entryId" [groupId]="groupId" [tagId]="tagId"></addon-blog-entries>\n'/*ion-inline-end:"D:\src\gupolenseignement\src\addon\blog\pages\entries\entries.html"*/,
        }),
